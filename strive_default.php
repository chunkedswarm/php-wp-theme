<!DOCTYPE html>
<!--  Last Published: Mon Jun 12 2017 16:22:22 GMT+0000 (UTC)  -->
<html data-wf-page="593e66bbb16e23436d9736a8" data-wf-site="593e66bbb16e23436d9736a7" lang="de">
<head>
  <meta charset="utf-8">
...
<body class="body">
  ...
  <div class="template-content-section">
    <div class="template-content-container w-container">
    <?php the_content(); ?>
    </div>
  </div>
    ...
    <div class="w-container">
      <div class="w-row">
        <div class="w-col w-col-4">
          <h4 class="footer-headline">Produkte</h4><a class="footer-page-link" href="/produkt">StriveCDN DataGrid</a><a class="footer-page-link" href="/produkt">StriveCDN TrafficBoost</a><a class="footer-page-link" href="/preise">Produktvergleich</a><a class="footer-page-link" href="/preise">Traffic Calculator</a><a class="footer-page-link" href="/preise">Preise</a>
        </div>
        <div class="w-col w-col-4">
          <h4 class="footer-headline">Unternehmen</h4><a class="footer-page-link" href="/about">Über Uns</a><a class="footer-page-link" href="mailto:info@strivecdn.com?subject=Hello!">Kontakt</a><a class="footer-page-link" href="/impressum">Impressum</a>
        </div>
        <div class="w-col w-col-4">
          <h4 class="footer-headline">Newsletter</h4>
          <div class="footer-newsletter-description">Jetzt anmelden und immer die neuesten Informationen vom StriveCDN Team erhalten!</div>
          <div class="w-form">
            <form class="footer-newsletter-form" data-name="Newsletter" data-redirect="/redirect/newsletter" id="wf-form-Newsletter" name="wf-form-Newsletter" redirect="/redirect/newsletter">
              <input class="footer-field optin-textfield w-input" data-name="Email 4" id="email-4" maxlength="256" name="email" placeholder="Emailadresse..." required="required" type="email">
              <input class="button w-button" data-wait="Bitte warten..." type="submit" value="Jetzt anmelden!">
            </form>
            <div class="w-form-done">
              <div>Vielen Dank,
      ...
      <div>
        <div class="footer-bottom-line">© 2017 Strive Media GmbH - Alle Rechte vorbehalten</div>
      </div>
    </div>
  </div>
  ...
  <script>
    $('#menu-english').click(function() {
        	alert('Sorry, English is coming soon!');
        });
  </script>
  <script>
    $(document).ready(
